...
impl Bitboard {
    ...
    pub const FOURTH_RANK: [Bitboard; 2] = [Bitboard::rank(Rank::R4), Bitboard::rank(Rank::R5)];
    pub const HOME_RANKS: [Bitboard; 2] = [Bitboard::rank(Rank::R1), Bitboard::rank(Rank::R8)];
